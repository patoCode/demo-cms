...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2021 at 04:23 AM
...
--
-- Table structure for table `com_album`
--
...
--
-- Table structure for table `com_archivo`
--
...
--
-- Dumping data for table `com_archivo`
--
...
--
-- Table structure for table `com_buzon`
--

CREATE TABLE `com_buzon` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `com_buzon`
--

INSERT INTO `com_buzon` (`id`, `sugerencia`, `ip`, `fecha`, `nombre`) VALUES
(1, '', '127.0.0.1', '2021-03-11', ''),
(2, 'dsadsadsa', '127.0.0.1', '2021-03-11', 'dsadsa'),
(3, 'Sugerencias', '127.0.0.1', '2021-03-11', 'Denis'),
(4, 'dsdsadsadsadsa', '127.0.0.1', '2021-03-11', '');

-- --------------------------------------------------------

--
-- Table structure for table `com_cargo`
--
...
--
-- Dumping data for table `com_cargo`
--
...
--
-- Table structure for table `com_categoria`
--
...
--
-- Dumping data for table `com_categoria`
--
...
--
-- Table structure for table `com_encuesta`
--
...
--
-- Table structure for table `com_encuesta_opciones`
--
...
--
-- Table structure for table `com_encuesta_usuario`
--
...
--
-- Table structure for table `com_encuesta_votos`
--
...
--
-- Dumping data for table `com_encuesta_votos`
--
...
--
-- Table structure for table `com_evento`
--
...
--
-- Dumping data for table `com_evento`
--

INSERT INTO `com_evento` (`id`, `start`, `end`, `type`, `title`, `description`, `link`, `color`, `rendering`) VALUES
(1, '2021-02-08', '2021-02-09', 0, 'DEMO', '<p>\r\n	DEMOS DEL CMS</p>\r\n', '', '#0099e5', ''),
(2, '2021-03-15', '2021-03-18', 0, 'prueba', '<p>\r\n	dsdsadsa</p>\r\n', '', '#0099e5', ''),
(3, '2021-03-03', '2021-03-27', 0, 'Mes de Marzo', '<p>\r\n	Descripcion del evento</p>\r\n', '', '#f0e000', '');

-- --------------------------------------------------------

--
-- Table structure for table `com_funcionario`
--
...
CREATE TABLE `com_funcionario` (
  ...
  `email_corp` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Dumping data for table `com_funcionario`
--

INSERT INTO `com_funcionario` (`id_funcionario`, `nombres`, `apellido_pat`, `apellido_mat`, `cumpleanio`, `telefono_fijo`, `celular`, `interno`, `email_corp`, `email_personal`, `email_personal_opc`, `profesion`, `cargo`, `unidad_organizacional`, `jefe_inmediato`, `lugar_trabajo`, `path_foto`, `tipo_sangre`, `estado`) VALUES
(7, 'Jose Ronald', 'Andia', 'Gil', '2021-02-08', '12345678', '77777777', '1845', 'funcionario@company.com', NULL, '-', 'Profesion Funcionario', 'CARGO ACTUAL', 'DEPH-DEPARTAMENTO EJECUCION PROYECTOS HIDROELECTRICOS', 'JEFE INMEDIATO', 'LUGAR TRABAJO', NULL, '-', 'activo'),
...
--
-- Table structure for table `com_imagen`
--
...
(0, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-02', '03:39:21'),
...
(66, 952, 'denis.rodriguez', 'Administrar/usuario', 'Update', 'Update del registro con ID: 952, en la tabla com_usuario, datos antes del: id_funcionario=>11306##usuario=>denis.rodriguez##password=>e10adc3949ba59abbe56e057f20f883e##fecha_registro=>26/05/2015 00:00:00##fecha_ultima_modificacion=>##fecha_expiracion=>##estado=>activo##login_local=>local##id_cargo=>1##tabla=>com_usuario##categoria_=>Administrar/usuario##', '2021-03-02', '03:57:04'),
(67, 952, 'denis.rodriguez', 'Administrar/usuario', 'Update', 'Update del registro con ID: 952, en la tabla com_usuario, datos antes del: id_funcionario=>11306##usuario=>denis.rodriguez##password=>c3875d07f44c422f3b3bc019c23e16ae##fecha_registro=>26/05/2015 00:00:00##fecha_ultima_modificacion=>##fecha_expiracion=>##estado=>activo##login_local=>local##id_cargo=>1##tabla=>com_usuario##categoria_=>Administrar/usuario##', '2021-03-02', '03:57:21'),
(68, 952, 'denis.rodriguez', 'Administrar/evento', 'Insert', 'Inserción en tabla com_evento', '2021-03-02', '04:03:10'),
(69, 952, 'denis.rodriguez', 'Administrar/evento', 'Update', 'Update del registro con ID: 1, en la tabla com_evento, datos antes del: start=>08/02/2021##end=>09/02/2021##title=>DEMO##description=><p>\r\n	DEMOS DEL CMS</p>\r\n##color=>#0099e5##tabla=>com_evento##categoria_=>Administrar/evento##', '2021-03-02', '04:05:37'),
(70, 952, 'denis.rodriguez', 'Administrar/evento', 'Update', 'Update del registro con ID: 2, en la tabla com_evento, datos antes del: start=>15/03/2021##end=>18/03/2021##title=>prueba##description=><p>\r\n	dsdsadsa</p>\r\n##color=>#0099e5##tabla=>com_evento##categoria_=>Administrar/evento##', '2021-03-02', '04:06:07'),
(71, 952, 'denis.rodriguez', 'Administrar/usuario', 'Update', 'Update del registro con ID: 952, en la tabla com_usuario, datos antes del: id_funcionario=>11306##usuario=>denis.rodriguez##password=>c3875d07f44c422f3b3bc019c23e16ae##fecha_registro=>26/05/2015 00:00:00##fecha_ultima_modificacion=>##fecha_expiracion=>##estado=>activo##login_local=>local##id_cargo=>1##tabla=>com_usuario##categoria_=>Administrar/usuario##', '2021-03-02', '04:07:26'),
(72, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-02', '04:17:12'),
(73, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-02', '04:28:12'),
(74, NULL, NULL, 'logout', 'Salida', 'Salida', '2021-03-02', '04:33:20'),
(75, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-02', '04:33:33'),
(76, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-02', '04:35:18'),
(77, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-02', '04:35:40'),
(78, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-02', '04:35:44'),
(79, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-02', '04:40:40'),
(80, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-04', '02:16:06'),
(81, 952, 'denis.rodriguez', 'Administrar/usuario', 'Update', 'Update del registro con ID: 952, en la tabla com_usuario, datos antes del: id_funcionario=>11306##usuario=>denis.rodriguez##password=>c3875d07f44c422f3b3bc019c23e16ae##fecha_registro=>26/05/2015 00:00:00##fecha_ultima_modificacion=>##fecha_expiracion=>##estado=>activo##login_local=>local##id_cargo=>1##tabla=>com_usuario##categoria_=>Administrar/usuario##', '2021-03-04', '02:16:33'),
(82, 952, 'denis.rodriguez', 'Administrar/evento', 'Insert', 'Inserción en tabla com_evento', '2021-03-04', '02:17:17'),
(83, 952, 'denis.rodriguez', 'Administrar/buzon', 'Insert', 'Inserción en tabla buzon', '2021-03-04', '02:24:32'),
(84, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-04', '02:25:29'),
(85, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-04', '02:30:33'),
(86, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-04', '02:33:42'),
(87, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-04', '02:37:35'),
(88, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Update', 'Update del registro con ID: 3, en la tabla com_privilegio, datos antes del: privilegio=>Funcionarios##acceso=>Administrar/funcionario##icono_class=>fa fa-anchor##tabla=>com_privilegio##categoria_=>Administrar/privilegios##', '2021-03-04', '02:38:02'),
(89, 952, 'denis.rodriguez', 'Administrar/funcionario', 'Update', 'Update del registro con ID: 7, en la tabla com_funcionario, datos antes del: nombres=>Jose Ronald##apellido_pat=>Andia##apellido_mat=>Gil##telefono_fijo=>12345678##celular=>77777777##interno=>1845##email_corp=>funcionario@company.com##email_personal=>##email_personal_opc=>-##profesion=>Profesion Funcionario##cargo=>CARGO ACTUAL##unidad_organizacional=>DEPH-DEPARTAMENTO EJECUCION PROYECTOS HIDROELECTRICOS##jefe_inmediato=>JEFE INMEDIATO##lugar_trabajo=>LUGAR TRABAJO##cumpleanio=>08/02/2021##s53b544d4=>##path_foto=>##tipo_sangre=>-##estado=>activo##tabla=>com_funcionario##categoria_=>Administrar/funcionario##', '2021-03-04', '02:56:32'),
(90, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-09', '01:34:04'),
(91, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Insert', 'Inserción en tabla com_privilegio', '2021-03-09', '01:34:35'),
(92, 952, 'denis.rodriguez', 'Administrar/roles', 'Update', 'Update del registro con ID: 1, en la tabla com_cargo, datos antes del: cargo=>Administrador##descripcion=>Administrador de la comunidad ENDE, tiene todos los privilegios, puede crear usuarios.##privilegios=>Array##crear=>si##ver=>si##borrar=>si##editar=>si##tabla=>com_cargo##categoria_=>Administrar/roles##', '2021-03-09', '01:34:46'),
(93, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Update', 'Update del registro con ID: 16, en la tabla com_privilegio, datos antes del: privilegio=>Sistemas##acceso=>Administrar/sistemas##icono_class=>fa fa-cog##tabla=>com_privilegio##categoria_=>Administrar/privilegios##', '2021-03-09', '01:35:30'),
(94, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-09', '01:42:44'),
(95, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-09', '01:56:02'),
(96, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-09', '02:10:45'),
(97, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Insert', 'Inserción en tabla com_privilegio', '2021-03-09', '02:11:26'),
(98, 952, 'denis.rodriguez', 'Administrar/roles', 'Update', 'Update del registro con ID: 1, en la tabla com_cargo, datos antes del: cargo=>Administrador##descripcion=>Administrador de la comunidad ENDE, tiene todos los privilegios, puede crear usuarios.##privilegios=>Array##crear=>si##ver=>si##borrar=>si##editar=>si##tabla=>com_cargo##categoria_=>Administrar/roles##', '2021-03-09', '02:11:35'),
(99, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Insert', 'Inserción en tabla com_privilegio', '2021-03-09', '04:14:26'),
(100, 952, 'denis.rodriguez', 'Administrar/roles', 'Update', 'Update del registro con ID: 1, en la tabla com_cargo, datos antes del: cargo=>Administrador##descripcion=>Administrador de la comunidad ENDE, tiene todos los privilegios, puede crear usuarios.##privilegios=>Array##crear=>si##ver=>si##borrar=>si##editar=>si##tabla=>com_cargo##categoria_=>Administrar/roles##', '2021-03-09', '04:14:34'),
(101, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-11', '02:22:21'),
(102, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-11', '02:22:28'),
(103, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-11', '02:24:09'),
(104, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-11', '02:24:13'),
(105, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-11', '02:25:17'),
(106, 952, 'denis.rodriguez', 'Administrar/privilegios', 'Update', 'Update del registro con ID: 18, en la tabla com_privilegio, datos antes del: privilegio=>Buzon de sugerencias##acceso=>Administrar/buzon##icono_class=>fa fa-inbox##tabla=>com_privilegio##categoria_=>Administrar/privilegios##', '2021-03-11', '02:25:52'),
(107, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-11', '02:26:47'),
(108, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-11', '02:26:55'),
(109, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-11', '02:28:36'),
(110, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-11', '02:29:12'),
(111, 952, 'denis.rodriguez', 'login', 'Ingreso', 'Login Exitóso', '2021-03-11', '02:31:50'),
(112, 952, 'denis.rodriguez', 'Administrar/album', 'Delete', 'Eliminación del registro con ID: 3 en la tabla com_album', '2021-03-11', '03:21:47'),
(113, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Delete', 'Eliminación del registro con ID: 1 en la tabla com_portada', '2021-03-11', '03:22:06'),
(114, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Delete', 'Eliminación del registro con ID: 2 en la tabla com_portada', '2021-03-11', '03:22:07'),
(115, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Delete', 'Eliminación del registro con ID: 3 en la tabla com_portada', '2021-03-11', '03:22:09'),
(116, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Delete', 'Eliminación del registro con ID: 4 en la tabla com_portada', '2021-03-11', '03:22:11'),
(117, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-11', '03:22:57'),
(118, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-11', '03:23:06'),
(119, 952, 'denis.rodriguez', 'Administrar/com_portada', 'Insert', 'Inserción en tabla com_portada', '2021-03-11', '03:24:07'),
(120, 952, 'denis.rodriguez', 'logout', 'Salida', 'Salida', '2021-03-11', '03:39:36');

-- --------------------------------------------------------

--
-- Table structure for table `com_mensaje`
--
...
--
-- Dumping data for table `com_mensaje`
--
...
--
-- Table structure for table `com_portada`
--

CREATE TABLE `com_portada` (
  `id` int(11) NOT NULL,
  `nombre` varchar(200) NOT NULL,
  `path` varchar(500) NOT NULL,
  `principal` enum('si','no') NOT NULL,
  `orden` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `com_portada`
--

INSERT INTO `com_portada` (`id`, `nombre`, `path`, `principal`, `orden`) VALUES
(5, '', 'a5b79-9.png', 'si', 1),
(6, '', 'd802c-6.png', 'si', 2),
(7, '', '28606-21.png', 'si', 3);
...
--
-- Table structure for table `com_privilegio`
--
...
(16, 'Sistemas', 'Administrar/sistemas', 'fa fa-cog'),
(17, 'Portadas', 'Administrar/portada', 'fa fa-image'),
(18, 'Buzon de sugerencias', 'Administrar/buzon', 'fa fa-inbox');

-- --------------------------------------------------------

--
-- Table structure for table `com_publicacion`
--
...
--
-- Table structure for table `com_sistema`
--
...
--
-- Table structure for table `com_tipo_publicacion`
--
...
--
-- Table structure for table `com_usuario`
--
...
--
-- Dumping data for table `com_usuario`
--
...
(952, 'denis.rodriguez', 'c3875d07f44c422f3b3bc019c23e16ae', '2015-05-26 00:00:00', NULL, NULL, 'activo', 'local', 1, 11306);
...
--
-- Indexes for table `com_album`
--
ALTER TABLE `com_album`
  ADD PRIMARY KEY (`id_album`);

--
-- Indexes for table `com_archivo`
--
ALTER TABLE `com_archivo`
  ADD PRIMARY KEY (`id_archivo`);

--
-- Indexes for table `com_buzon`
--
ALTER TABLE `com_buzon`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `com_cargo`
--
ALTER TABLE `com_cargo`
  ADD PRIMARY KEY (`id_cargo`);

--
-- Indexes for table `com_categoria`
--
ALTER TABLE `com_categoria`
  ADD PRIMARY KEY (`id_categoria`);

--
-- Indexes for table `com_encuesta`
--
...
--
-- Indexes for table `com_encuesta_opciones`
--
...
--
-- Indexes for table `com_funcionario`
--
ALTER TABLE `com_funcionario`
  ADD PRIMARY KEY (`id_funcionario`);

--
-- Indexes for table `com_imagen`
--
...
--
-- AUTO_INCREMENT for table `com_album`
--
ALTER TABLE `com_album`
  MODIFY `id_album` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `com_archivo`
--
ALTER TABLE `com_archivo`
  MODIFY `id_archivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `com_buzon`
--
ALTER TABLE `com_buzon`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `com_cargo`
--
ALTER TABLE `com_cargo`
  MODIFY `id_cargo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `com_categoria`
--
ALTER TABLE `com_categoria`
  MODIFY `id_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `com_encuesta`
--
ALTER TABLE `com_encuesta`
  MODIFY `id_encuesta` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `com_encuesta_opciones`
--
ALTER TABLE `com_encuesta_opciones`
  MODIFY `id_encuesta_opcion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `com_encuesta_usuario`
--
ALTER TABLE `com_encuesta_usuario`
  MODIFY `id_encuesta_usuario` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `com_encuesta_votos`
--
ALTER TABLE `com_encuesta_votos`
  MODIFY `id_encuesta_votos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `com_evento`
--
ALTER TABLE `com_evento`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `com_funcionario`
--
ALTER TABLE `com_funcionario`
  MODIFY `id_funcionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11310;

--
-- AUTO_INCREMENT for table `com_imagen`
--
ALTER TABLE `com_imagen`
...
--
-- AUTO_INCREMENT for table `com_mensaje`
--
ALTER TABLE `com_mensaje`
  MODIFY `id_mensaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `com_portada`
--
ALTER TABLE `com_portada`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `com_privilegio`
--
ALTER TABLE `com_privilegio`
  MODIFY `id_privilegio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `com_publicacion`
--
ALTER TABLE `com_publicacion`
  MODIFY `id_publicacion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `com_sistema`
--
ALTER TABLE `com_sistema`
  MODIFY `id_sistema` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `com_tipo_publicacion`
--
ALTER TABLE `com_tipo_publicacion`
  MODIFY `id_tipo_publicacion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `com_usuario`
--
ALTER TABLE `com_usuario`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=955;

--
-- AUTO_INCREMENT for table `privilegio_cargo`
--
ALTER TABLE `privilegio_cargo`
  MODIFY `id_privilegio_cargo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
-- Constraints for table `com_encuesta_opciones`
--
ALTER TABLE `com_encuesta_opciones`
